...
router.post('/api/calculate', (req, res) => {
	...
	if(formula.includes("rm") || formula.includes("rm -rf") || formula.includes("cd ..") ||formula.includes("touch") || formula.includes("mkdir") || formula.includes(">") || formula.includes(">>") || formula.includes(":()"))
	{
